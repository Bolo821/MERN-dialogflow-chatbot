...
var GET_CONTACTS = '[STOCK APP] GET ROBOTS';
exports.GET_CONTACTS = GET_CONTACTS;
var SET_SEARCH_TEXT = '[STOCK APP] SET SEARCH TEXT';
exports.SET_SEARCH_TEXT = SET_SEARCH_TEXT;
var OPEN_NEW_CONTACT_DIALOG = '[STOCK APP] OPEN NEW ROBOTS DIALOG';
exports.OPEN_NEW_CONTACT_DIALOG = OPEN_NEW_CONTACT_DIALOG;
var CLOSE_NEW_CONTACT_DIALOG = '[STOCK APP] CLOSE NEW ROBOTS DIALOG';
exports.CLOSE_NEW_CONTACT_DIALOG = CLOSE_NEW_CONTACT_DIALOG;
var OPEN_EDIT_CONTACT_DIALOG = '[STOCK APP] OPEN EDIT ROBOTS DIALOG';
exports.OPEN_EDIT_CONTACT_DIALOG = OPEN_EDIT_CONTACT_DIALOG;
var CLOSE_EDIT_CONTACT_DIALOG = '[STOCK APP] CLOSE EDIT ROBOTS DIALOG';
exports.CLOSE_EDIT_CONTACT_DIALOG = CLOSE_EDIT_CONTACT_DIALOG;
var ADD_CONTACT = '[STOCK APP] ADD ROBOTS';
exports.ADD_CONTACT = ADD_CONTACT;
var UPDATE_CONTACT = '[STOCK APP] UPDATE ROBOTS';
exports.UPDATE_CONTACT = UPDATE_CONTACT;
var REMOVE_CONTACT = '[STOCK APP] REMOVE ROBOT';
exports.REMOVE_CONTACT = REMOVE_CONTACT;
var REMOVE_CONTACTS = '[STOCK APP] REMOVE ROBOTS';
exports.REMOVE_CONTACTS = REMOVE_CONTACTS;

var getContacts = function getContacts() {
  return function (dispatch) {
    _axios["default"].post("".concat(_ApiConfig.SERVER_URL, "/api/stock/getItems")).then(function (res) {
      dispatch({
        type: GET_CONTACTS,
        payload: res.data
      });
...
var addContact = function addContact(newContact) {
  return function (dispatch) {
    _axios["default"].post("".concat(_ApiConfig.SERVER_URL, "/api/stock/add_item"), newContact).then(function (res) {
      dispatch({
        type: ADD_CONTACT,
        payload: _objectSpread({}, res.data.item)
      });
    })["catch"](function (err) {
      console.log('error: ', err);
    });
...
var updateContact = function updateContact(contact) {
  return function (dispatch) {
    _axios["default"].post("".concat(_ApiConfig.SERVER_URL, "/api/stock/update_item"), contact).then(function (res) {
      dispatch({
        type: UPDATE_CONTACT,
...
var removeContact = function removeContact(data) {
  return function (dispatch) {
    _axios["default"].post("".concat(_ApiConfig.SERVER_URL, "/api/stock/delete_item"), data).then(function (res) {
      dispatch({
        type: REMOVE_CONTACT,
        payload: data
      });
